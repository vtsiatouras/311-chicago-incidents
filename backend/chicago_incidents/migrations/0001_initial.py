    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('graffiti', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tree_incidents', to='chicago_incidents.graffiti')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='number_of_carts_and_potholes', to='chicago_incidents.incident')),
            ],
            options={
