...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='incident',
            index=models.Index(fields=['creation_date', 'status', 'completion_date', 'service_request_number', 'type_of_service_request', 'current_activity', 'street_address'], name='incidents_creatio_449f47_idx'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='codeviolationincident',
            name='incident',
