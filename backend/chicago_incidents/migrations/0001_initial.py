# Generated by Django 3.1.3 on 2020-11-29 23:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='incident',
            index=models.Index(fields=['street_address'], name='incidents_street__09a434_idx'),
        ),
        migrations.AddIndex(
            model_name='incident',
        ...
        migrations.AddIndex(
            model_name='incident',
            index=models.Index(fields=['latitude'], name='incidents_latitud_cc43fc_idx'),
        ),
        migrations.AddIndex(
            model_name='incident',
            index=models.Index(fields=['longitude'], name='incidents_longitu_9b83b1_idx'),
        ),
        migrations.AddIndex(
            model_name='incident',
            index=models.Index(fields=['ssa'], name='incidents_ssa_fd854b_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='incident',
            unique_together={('creation_date', 'status', 'completion_date', 'service_request_number', 'type_of_service_request', 'street_address')},
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='abandonedvehicleincident',
            index=models.Index(fields=['incident'], name='abandoned_v_inciden_480494_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='abandonedvehicleincident',
