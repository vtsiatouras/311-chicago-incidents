<template>
  <div class="container">
    <header class="jumbotron">
      ...
      <hr class="my-4">
      <p>Here you can create any type of incident you want. Just fill the fields below.</p>
    </header>
    <form name="form" @submit.prevent="handleSubmit">
      <div v-if="!successful">
        ...
        <div class="form-group">
          ...
          <div
              v-if="submitted && errors.has('latitude')"
              class="alert-danger"
          ...
          <div
              v-if="submitted && errors.has('longitude')"
              class="alert-danger"
          ...
          <div
              v-if="submitted && errors.has('ward')"
              class="alert-danger"
          >{{ errors.first('ward') }}
          </div>
          ...
          <div
              v-if="submitted && errors.has('zip_codes')"
              class="alert-danger"
          ...
          <div
              v-if="submitted && errors.has('wards')"
              class="alert-danger"
          >{{ errors.first('wards') }}
          </div>
          ...
          <label for="community_areas">Community Areas (Appears in newer datasets)</label>
          <b-form-input
              class="mb-3"
        ...
        <div class="form-group"
             v-if="['ABANDONED_VEHICLE', 'GARBAGE_CART', 'POT_HOLE', 'RODENT_BAITING', 'TREE_DEBRIS'].
        ...
        <div class="form-group" v-if="incident.type_of_service_request === 'ABANDONED_VEHICLE'">
        ...
        <div class="form-group" v-if="incident.type_of_service_request === 'GRAFFITI'">
          ...
          <div
              v-if="submitted && errors.has('surface')"
              class="alert-danger"
